...
For example, if you write a Medium post titled "Stop Using Reduce", it's likely the URL would have some form of the title string
in it (".../stop-using-reduce"). You may have already noticed this on the freeCodeCamp site.
*/
...
// the global variable
var globalTitle1 = "Winter Is Coming";
var globalTitle2 = "Winter Is  Coming";
// Add your code below this line
function urlSlug(title) {
return title.split(/\W/g).filter(elt=>elt!="").join("-").toLowerCase();

}
// Add your code above this line

console.log(urlSlug(globalTitle1)); // Should be "winter-is-coming"
console.log(urlSlug(globalTitle2)); // Should be "winter-is-coming"